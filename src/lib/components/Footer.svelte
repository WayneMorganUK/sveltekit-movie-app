...
<footer class="fixed bottom-0 z-50 w-full bg-skin-primary">
	<div class="max-w-7xl mx-auto flex flex-col md:flex-row md:justify-between ">
		...
		>
			<div class=" text-xs md:text-base text-skin-inverted flex flex-row items-center">
				Powered by <a
					class=" text-xs md:text-base pl-1 text-cyan-300 hover:text-skin-selected"
		...
		<div
			class=" text-xs md:text-base text-skin-inverted md:flex-grow flex flex-wrap justify-center md:justify-end md:pr-2 items-center"
		>
			<p>This product uses the</p>

			<svg
				class="h-[8px] md:h-[12px] px-2"
