...
{#if tv_details.id && trailer_details}
	<section
		id="media"
		class="bg-right-top bg-no-repeat bg-contain text-skin-inverted md:mt-5 md:bg-cover md:rounded-2xl"
				...
				<div class="flex flex-wrap content-start md:col-start-2 md:col-end-5 md:pl-10">
					...
					>
						{#if trailer_details.length > 0}
							...
							{/each}
							<!-- <p class="flex items-center justify-center ml-4 text-2xl">Play Trailers</p> -->
						{:else}
							<div class="flex pl-5">
