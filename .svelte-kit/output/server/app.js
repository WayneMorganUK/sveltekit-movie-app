import { c as create_ssr_component, s as setContext, v as validate_component, m as missing_component } from "./chunks/index-bac2f3ba.js";
...
const getCookieValue = (cookie, name) => cookie.match("(^|;)\\s*" + name + "\\s*=\\s*([^;]+)")?.pop() || null;
const getSession = ({ request }) => {
  const theme = request.headers.get("cookie") ? getCookieValue(request.headers.get("cookie"), "theme") : null;
  return { theme };
};
