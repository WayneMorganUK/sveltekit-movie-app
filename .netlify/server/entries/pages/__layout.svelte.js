...
var app = "";
const ToggleDarkMode = (0, import_index_bac2f3ba.c)(($$result, $$props, $$bindings, slots) => {
  let $theme, $$unsubscribe_theme;
  $$unsubscribe_theme = (0, import_index_bac2f3ba.b)(import_theme_55fe6b69.t, (value) => $theme = value);
  $$unsubscribe_theme();
  return `<button class="${"text-skin-inverted"}"><div class="${"flex justify-center w-8 h-8 mr-2 align-middle border-2 rounded-full border-skin-border focus:outline-none"}" aria-label="${"Toggle Light and Dark mode"}">${$theme === import_theme_55fe6b69.T.Dark ? `<span><i class="${"text-yellow-400 fa fa-sun-o"}" id="${"toggle-switch"}"></i></span>` : `<span><i class="${"text-gray-300 fa fa-moon-o"}" id="${"toggle-switch"}"></i></span>`}</div></button>`;
});
const Search = (0, import_index_bac2f3ba.c)(($$result, $$props, $$bindings, slots) => {
  let searchTerm;
  return `<section id="${"search"}" class="${"flex flex-row"}">${(0, import_index_bac2f3ba.v)(ToggleDarkMode, "ToggleDarkMode").$$render($$result, {}, {}, {})}
	<form class="${"flex justify-end items-center pr-0.5"}" label="${"search form"}"><input label="${"search"}" class="${"bg-transparent w-24 lg:w-48 h-8 rounded-full text-lg px-2 placeholder-text-skin-base::placeholder border-2 border-skin-border"}" type="${"text"}" placeholder="${"Search..."}"${(0, import_index_bac2f3ba.d)("value", searchTerm, 0)}></form></section>`;
});
const Genre = (0, import_index_bac2f3ba.c)(($$result, $$props, $$bindings, slots) => {
  let $movie_genres, $$unsubscribe_movie_genres;
  let $selected, $$unsubscribe_selected;
  let $media_type, $$unsubscribe_media_type;
  let $tv_genres, $$unsubscribe_tv_genres;
  $$unsubscribe_movie_genres = (0, import_index_bac2f3ba.b)(import_store_56c5f052.m, (value) => $movie_genres = value);
  ...
  $$unsubscribe_tv_genres = (0, import_index_bac2f3ba.b)(import_store_56c5f052.t, (value) => $tv_genres = value);
  ...
  return `<div class="${"w-full bg-skin-primary"}"><div class="${"flex flex-row p-1"}"><div class="${"flex flex-col p-1 m-1 bg-skin-secondary"}"><h6 class="${"uppercase text-skin-base"}"><span class="${"mr-2"}"><i class="${"fa fa-video-camera"}" aria-hidden="${"true"}"></i></span>Movies
			...
			<ul class="${"flex flex-col justify-center text-sm "}">${(0, import_index_bac2f3ba.e)($movie_genres, (genre) => {
    return `<li class="${"flex"}"><button${(0, import_index_bac2f3ba.d)("aria-label", genre.name, 0)} class="${[
      ...
      $selected === genre.id && $media_type === "movie" ? "bg-selected" : ""
    ].join(" ").trim()}">${(0, import_index_bac2f3ba.f)(genre.name)}</button>
					</li>`;
  })}</ul></div>
		<div class="${"flex flex-col p-1 m-1 bg-skin-secondary"}"><h6 class="${"flex uppercase text-skin-base"}"><span class="${"mr-2"}"><i class="${"fa fa-tv"}" aria-hidden="${"true"}"></i></span>Tv
			...
			<ul class="${"flex flex-col justify-center text-sm"}">${(0, import_index_bac2f3ba.e)($tv_genres, (genre) => {
...
const Selector = (0, import_index_bac2f3ba.c)(($$result, $$props, $$bindings, slots) => {
  let $media_type, $$unsubscribe_media_type;
  let $$unsubscribe_selected;
  $$unsubscribe_media_type = (0, import_index_bac2f3ba.b)(import_store_56c5f052.a, (value) => $media_type = value);
  $$unsubscribe_selected = (0, import_index_bac2f3ba.b)(import_store_56c5f052.s, (value) => value);
  $$unsubscribe_media_type();
  $$unsubscribe_selected();
...
<div class="${"pl-6 xl:pl-8 "}"><div class="${"group inline-block relative z-50"}"><button aria-label="${"Genres"}" class="${"text-skin-inverted font-semibold py-2 rounded inline-flex items-center hover:text-skin-selected"}"><span><i class="${"fa fa-tag"}" aria-hidden="${"true"}"></i></span>
			...
			<ul class="${"rounded xl:absolute fixed left-0 hidden bg-skin-primary text-skin-base group-hover:block"}">${(0, import_index_bac2f3ba.v)(Genre, "Genre").$$render($$result, {}, {}, {})}</ul></div></div>`;
});
const Header = (0, import_index_bac2f3ba.c)(($$result, $$props, $$bindings, slots) => {
  let $$unsubscribe_media_type;
  $$unsubscribe_media_type = (0, import_index_bac2f3ba.b)(import_store_56c5f052.a, (value) => value);
  $$unsubscribe_media_type();
  return `<header class="${"w-full z-50 fixed top-0 h-12 bg-skin-primary"}"><div class="${"h-12 max-w-7xl mx-auto flex justify-between pl-2 md:pl-5 lg:pl-7 pr-1 items-center "}"><div class="${"flex flex-row items-center"}"><button class="${"text-3xl text-skin-inverted hover:text-skin-selected"}" href="${"/"}"><i class="${"fa fa-home"}"></i></button>
			${(0, import_index_bac2f3ba.v)(Selector, "Selector").$$render($$result, {}, {}, {})}</div>

		${(0, import_index_bac2f3ba.v)(Search, "Search").$$render($$result, {}, {}, {})}</div></header>`;
});
async function load({ fetch }) {
  try {
    const resTv = await (await fetch("/api/getTvGenres")).json();
    import_store_56c5f052.t.set(resTv.tv_genres);
    const resMovie = await (await fetch("/api/getMovieGenres")).json();
    import_store_56c5f052.m.set(resMovie.movie_genres);
    return {};
  } catch (e) {
    console.log("error", e);
  }
}
const _layout = (0, import_index_bac2f3ba.c)(($$result, $$props, $$bindings, slots) => {
  let $theme, $$unsubscribe_theme;
  $$unsubscribe_theme = (0, import_index_bac2f3ba.b)(import_theme_55fe6b69.t, (value) => $theme = value);
  $$unsubscribe_theme();
...
<main${(0, import_index_bac2f3ba.d)("class", $theme, 0)}><div class="${"fixed top-0 w-full min-h-screen -z-50 bg-gradient-to-r from-skin-bg to-skin-border"}"></div>

	${(0, import_index_bac2f3ba.v)(Header, "Header").$$render($$result, {}, {}, {})}
