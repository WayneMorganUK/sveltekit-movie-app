...
const Root = (0, import_index_bac2f3ba.c)(($$result, $$props, $$bindings, slots) => {
  let { stores } = $$props;
  let { page } = $$props;
  ...
  (0, import_index_bac2f3ba.s)("__svelte__", stores);
...
${components[1] ? `${(0, import_index_bac2f3ba.v)(components[0] || import_index_bac2f3ba.m, "svelte:component").$$render($$result, Object.assign(props_0 || {}), {}, {
    default: () => {
      return `${components[2] ? `${(0, import_index_bac2f3ba.v)(components[1] || import_index_bac2f3ba.m, "svelte:component").$$render($$result, Object.assign(props_1 || {}), {}, {
        default: () => {
          return `${(0, import_index_bac2f3ba.v)(components[2] || import_index_bac2f3ba.m, "svelte:component").$$render($$result, Object.assign(props_2 || {}), {}, {})}`;
        }
      })}` : `${(0, import_index_bac2f3ba.v)(components[1] || import_index_bac2f3ba.m, "svelte:component").$$render($$result, Object.assign(props_1 || {}), {}, {})}`}`;
    }
  })}` : `${(0, import_index_bac2f3ba.v)(components[0] || import_index_bac2f3ba.m, "svelte:component").$$render($$result, Object.assign(props_0 || {}), {}, {})}`}
...
const getCookieValue = (cookie, name) => {
  var _a;
  return ((_a = cookie.match("(^|;)\\s*" + name + "\\s*=\\s*([^;]+)")) == null ? void 0 : _a.pop()) || null;
};
const getSession = ({
  headers
}) => {
  const theme = headers.cookie ? getCookieValue(headers.cookie, "theme") : null;
  return { theme };
};
